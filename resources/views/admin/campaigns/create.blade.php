            ...
            <div class="card-body">
                <form id="campaignForm" action="{{ route('campaigns.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="editor" rows="3" name="content" placeholder="Enter content" required></textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <div id="preview-container" class="mt-3 mb-3" style="display: none;">
                            <img id="preview" src="#" alt="Image Preview" style="max-width: 200px; height: auto;">
                        </div>
                    </div>
                    <div class="form-group">
